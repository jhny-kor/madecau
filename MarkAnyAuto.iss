...
SetupIconFile=MarkAnyAuto.ico
UninstallDisplayIcon={app}\MarkAnyAuto.exe
Compression=lzma2
...
[Icons]
Name: "{group}\madecau"; Filename: "{app}\MarkAnyAuto.exe"
Name: "{autodesktop}\madecau"; Filename: "{app}\MarkAnyAuto.exe"
